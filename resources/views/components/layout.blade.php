...
-->
    <div class="min-h-full">
            ...
            <el-disclosure id="mobile-menu" hidden class="block md:hidden">
                ...
                <div class="border-t border-white/10 pt-4 pb-3">
                    <div class="flex items-center px-5">
                        ...
                        <div class="ml-3">
                            <div class="text-base/5 font-medium text-white">Al Haj Ahmed</div>
                            <div class="text-sm font-medium text-gray-400">https://github.com/Drkiller325</div>
                        </div>
        ...
        <header class="relative bg-white after:pointer-events-none after:absolute after:inset-x-0 after:inset-y-0 after:border-y after:border-white/10">
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 sm:flex sm:justify-between"> <?php //"sm:" means for small devices and up ?>
